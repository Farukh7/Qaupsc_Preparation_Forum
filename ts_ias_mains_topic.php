    ...
    <div class="container py-5 pt-lg-0">
        ...
        <div class="row "   >
            ...
            <div class="col-lg-8">
                ...
                $sql=mysqli_query($con,"SELECT * FROM `ts_ias_mains_topic` ORDER BY ts_ias_mains_topic_id DESC"); 
                    ...
                    <div class=" wow fadeIn" data-wow-delay="0.1s">
                        <div class="bg-white shadow d-flex align-items-center " style="min-height: 150px;     padding-right: 45px;     padding-left: 45px;">
                            <div class="d-flex">
                                ...
                                <div class="ps-4">
                                 ...
                                 href=
                                  ...
                                  <?php 
                                                ...
                                                {
                                                    echo  "ts_ias_mains_topic_question.php?id=".$ts_ias_mains_topic_id."" ; 
                                                }
                                                else
                                                {
                                ...
                                class="list-group-item " style="color:black;text-align:left;font-weight:bold;font-size:22px;letter-spacing:1.5px;line-height:1.4;"><?php echo $ts_ias_mains_topic_topic?></a> 
