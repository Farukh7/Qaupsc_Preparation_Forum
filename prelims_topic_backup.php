...
<section>
    <div class="container facts py-5 pt-lg-0">
        <div class="container py-5 pt-lg-0">
            ...
            <div class="row">
                <div class="col-md-8" style="background-color:blue; height: auto;">  <?php 
                @$type=$_GET['type'];
                $sql=mysqli_query($con,"SELECT * FROM `pp_test` where pp_test_type='$type' ORDER BY pp_test_id DESC");
                ...
                <?php }?></div>
                <div class="col-md-4" style="background-color:; height: auto;">
                    <div class="container">
