...
$sql=mysqli_query($con,"INSERT INTO `ts_ac_s_topic_answer`(`ts_ac_s_topic_question_id`,`ts_ac_s_topic_id`,`ts_ac_s_topic_answers`,`file`,`student_email`,`ts_ac_s_topic_answer_date`) VALUES ('$z','$topic_id','$n','$c',trim('$student_email'),'$date')");
        if($sql){
...
<section class="ftco-section">
  <div class="container">
    <div class="accordion-div p-3">
      ...
      @$chap_name=$_GET['id'];
      $sql=mysqli_query($con,"SELECT * FROM `ts_ac_s_topic_question` where ts_ac_s_topic_id='$chap_name'  ORDER BY ts_ac_s_topic_id  DESC  ");
      $a=0;
          ...
          
        {
          ...
          <button class="accordion" type="button" style="width: 80%"> <?php echo @$ts_ac_s_topic_questions;?>&nbsp;? </button>
          <div class="panel">
            <br>
              ...
              <div class="row pt-4">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="question_id[]" class="form-control" value="
                              <?php echo $ts_ac_s_topic_question_id;?>">
                    <input type="hidden" name="topic_id" class="form-control" value="
                                <?php echo $ts_ac_s_topic_id;?>">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <!-- <a class="btn btn-primary" href="ts_ac_s_all_answers.php?id=<?php echo $ts_ac_s_topic_question_id ?>">View All Answers</a> -->
                  </div>
                </div>
                <b><hr></b><br><br>
               </div>
