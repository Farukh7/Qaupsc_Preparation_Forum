...
<section>
 <div class="container bootstrap snippets bootdey">
    <h4 class="font-50 text-center pb-4">Question: 
        ...
        <?php
        $query3=mysqli_query($con,"SELECT * FROM ts_uppsc_mains_topic_question where ts_uppsc_mains_topic_question_id = $question_id   ");
        $result3=mysqli_fetch_array($query3);
        echo $result3['ts_uppsc_mains_topic_questions'];
    ...
    <div class="container bootstrap snippets bootdey">
        <div class="row">
         <?php
         $query=mysqli_query($con,"SELECT * FROM ts_uppsc_mains_topic_answer where ts_uppsc_mains_topic_question_id = $question_id  AND file NOT LIKE '%.pdf' ");
                    ...
                    <ul class="list-listings">
                        <li class="featured">                            
                           ...
                           <div class="listing-image">
                            <?php echo $get['ts_uppsc_mains_topic_answers']; ?>
                        ...
                        <div class="listing-body">
                           <p>
                              <?php echo @$get['ts_uppsc_mains_topic_questions'];?>
                          </p>
...
<section class="mb-5">
    ...
    <div class="container bootstrap snippets bootdey">
        ...
        <div class="row">
          ...
          $sql2=mysqli_query($con,"SELECT * FROM `ts_uppsc_mains_topic_answer` where ts_uppsc_mains_topic_question_id = $question_id  AND  file LIKE '%.pdf'  ORDER BY ts_uppsc_mains_topic_answer_id DESC "); 
