...
<section class="ftco-section" style="margin-bottom: -50px;">
    ...
    <h5 class="font-50 text-center pb-5" style="margin-top:-80px"><strong>  </strong></h5>
      ...
      <div class="container">
          <form action="epfo_test_data.php?test_id=<?php echo $test_id ?>" method="post">
            <div class="row">

             <?php 
             
             $sql=mysqli_query($con,"SELECT * FROM `epfo_test_questions` where epfo_test_topic='$test_id'");
             $a=0;
            ...
            <?php }else{
             while($fetch=mysqli_fetch_array($sql)){
                ...
                <div class="col-md-12 course ftco-animate container p-3 my-3 border ">
                    Question <?php echo $a;?>  <h5><?php echo $epfo_test_question ?></h5>
                    
                    
                    <input type="radio" name="select_op<?php  echo $a;   ?>" 
                    value="<?php echo '1'; ?>">
                    &nbsp;&nbsp;<?php echo $epfo_test_op1; ?><br>
                    
                    <input type="radio" name="select_op<?php  echo $a;   ?>"
                    value="<?php echo '2'; ?>">
                    &nbsp;&nbsp;<?php echo $epfo_test_op2; ?><br> 

                    <input type="radio" name="select_op<?php  echo $a;   ?>" 
                    value="<?php echo '3'; ?>">
                    &nbsp;&nbsp;<?php echo $epfo_test_op3; ?><br>    
                    
                    <input type="radio" name="select_op<?php  echo $a;   ?>" 
                    value="<?php echo '4'; ?>">
                    &nbsp;&nbsp;<?php echo $epfo_test_op4; ?><br>
                    
                    
                    <input type="hidden" name="question<?php  echo $a;   ?>" value="<?php echo $epfo_test_id?>">
