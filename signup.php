...
echo "<script>alert('Login Successfully');window.location.href='question.php?chap_name=$chap_name'</script>";
}else{
...
.container:before {
  ...
  background-image: linear-gradient(-45deg, #0C2B48 0%, #0C2B48 100%);
      ...
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form action="#" class="sign-in-form" method="post">
              <?php @$chap_name=$_GET['chap_name'];
if($chap_name==null){?>
<a href="index.php"><button type="button" id="home" class="btn btn-dark">👈 GO BACK</button></a>
<?php }else{?>
  <a href="question.php?chap_name=$chap_name"><button type="button" id="home" class="btn btn-dark">👈 GO BACK</button></a>
  <?php }?>
