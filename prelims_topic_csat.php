        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="position-relative overflow-hidden  pt-5 h-100" style="min-height: 400px;">
                    <img class="position-absolute w-100 h-100" src="images/gss.jpeg" alt="" style="object-fit: cover;">
                    <img class="position-absolute top-0 start-0 bg-white pe-3 pb-3" src="images/gss.jpeg" alt="" style="width: 200px; height: 200px;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="text-align: justify;">
                <div class="h-100">
                    ...
                    <!--<p class="mb-4">We all know how important a civil servant's role is in building an ideal society and a strong nation. That’s why our vision is not just to teach and complete the syllabus; rather the larger agenda is to produce as many of successful students as is humanly possible. More importantly, we are aimed at instilling human values, ethical values and compassion into our students, to make them better human beings and civil servants.</p>-->
...
<section>
    <div class="container facts py-5 pt-lg-0">
        <div class="container py-5 pt-lg-0">
            ...
            <div class="row">
                <div class="col-md-8" style=" height: auto;">  <?php 
                    ...
                    <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                        <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                            <div class="d-flex" >
                                ...
                                <div class="ps-4" >
                                    <a href= "<?php echo $val."?test_id=".$pp_test_id; ?>"class="list-group-item"  style="color:black;text-align:center;font-weight:bold;font-size:22px;letter-spacing:1.5px;line-height:2.0;"><?php echo $pp_test_topic?></h3></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php }?></div>
                <div class="col-md-4" style="background-color:; height: auto; text-align: justify;">
                    <div class="container">
