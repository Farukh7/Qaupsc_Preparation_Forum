        ...
        <div class="container py-5 pt-lg-0">
            ...
            <div class="row">
                <div class="col-md-8" style=" height: auto;">  
                    ...
                    $sql=mysqli_query($con,"SELECT * FROM `uppsc_test` ORDER BY uppsc_test_id  DESC");
                                ...
                                <div class="d-flex" >
                                        <div class="flex-shrink-0 btn-lg-square bg-primary">
                                            ...
                                            <div class="ps-4" >
                                                ...
                                                {
                                                    echo  "uppsc_test_attempt.php?test_id=".$uppsc_test_id."";
                                                }
                                                else
                                                {
                                                ...
                                                ?> class="list-group-item"  style="color:black;text-align:center;font-weight:bold;font-size:22px;letter-spacing:1.5px;line-height:2.0;"><?php echo $uppsc_test_topic?></h3></a>
                                            </div>
                                </div>
                            </div>
                        </div>
